...
# RAMOS
RAMOS is a Linux-based kernel extension that supports software-defined
...
released soon. Before building the kernel, you should first launch a guest VM
with [RamRyder](/memx-ramryder/overview) and then follow the
[Quick Start](/memx-ramos/build) to build the RAMOS kernel for virtual
machines.
