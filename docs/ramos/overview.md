...
Currently, [RamRyder](/ramryder/overview) uses the RAMOS kernel in
...
with [RamRyder](/ramryder/overview) and then follow the
[Quick Start](/ramos/build) to build the RAMOS kernel for virtual
machines.
