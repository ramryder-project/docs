...
Currently, [RamRyder](/) uses the RAMOS kernel in
...
with [RamRyder](/) and then follow
[Kernel Installation](/getting-started/kernel-installation) to
build the RAMOS kernel for virtual
machines.
